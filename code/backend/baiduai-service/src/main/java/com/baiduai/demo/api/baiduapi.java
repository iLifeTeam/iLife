...
public class baiduapi {
    ...
    public static String getAuth() {
        ...
        String clientId = "M7DUCv3BnfumFjfAmv15o0iV";
        // 官网获取的 Secret Key 更新为你注册的
        String clientSecret = "HRcQdh4Xh0UZA6sULDZo8uYkG2jd7czY";
...
//            System.err.println("result:" + result);
    ...
    public int analysis(String token,String txt) throws IOException {
        ...
        String js = "{\"text\":\""+txt+"\"}";
        StringEntity se = new StringEntity(js, Charsets.UTF_8);
        ...
        JSONObject jsonObject1 = (JSONObject) jsonObject.getJSONArray("items").get(0);
        int sentiment = jsonObject1.getInteger("sentiment");
        return sentiment;
    }
}
