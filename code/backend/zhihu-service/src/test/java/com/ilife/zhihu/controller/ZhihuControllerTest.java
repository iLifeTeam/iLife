...
class ZhihuControllerTest {
    ...
    void getArticle() throws Exception {
        MockHttpServletRequestBuilder getRequest = MockMvcRequestBuilders.get("/article").param("id", "28");
        ResultActions perform = mockMvc.perform(getRequest);
        perform.andExpect(MockMvcResultMatchers.status().isOk());
        MvcResult mvcResult = perform.andReturn();
        MockHttpServletResponse response = mvcResult.getResponse();
    ...
    void getQuestion() throws Exception {
        MockHttpServletRequestBuilder getRequest = MockMvcRequestBuilders.get("/question").param("id", "208");
        ResultActions perform = mockMvc.perform(getRequest);
        perform.andExpect(MockMvcResultMatchers.status().isOk());
        MvcResult mvcResult = perform.andReturn();
        MockHttpServletResponse response = mvcResult.getResponse();
    ...
    void getAnswer() throws Exception {
        MockHttpServletRequestBuilder getRequest = MockMvcRequestBuilders.get("/answer").param("id", "533");
        ResultActions perform = mockMvc.perform(getRequest);
        perform.andExpect(MockMvcResultMatchers.status().isOk());
        MvcResult mvcResult = perform.andReturn();
        MockHttpServletResponse response = mvcResult.getResponse();
