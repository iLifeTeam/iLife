...
public final class ZhihuServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<Zhihu.UserInfoRequest,
      Zhihu.UserinfoResponse> getGetUserInfoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetUserInfo",
      requestType = Zhihu.UserInfoRequest.class,
      responseType = Zhihu.UserinfoResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Zhihu.UserInfoRequest,
      Zhihu.UserinfoResponse> getGetUserInfoMethod() {
    io.grpc.MethodDescriptor<Zhihu.UserInfoRequest, Zhihu.UserinfoResponse> getGetUserInfoMethod;
    if ((getGetUserInfoMethod = ZhihuServiceGrpc.getGetUserInfoMethod) == null) {
      synchronized (ZhihuServiceGrpc.class) {
        if ((getGetUserInfoMethod = ZhihuServiceGrpc.getGetUserInfoMethod) == null) {
          ZhihuServiceGrpc.getGetUserInfoMethod = getGetUserInfoMethod =
              io.grpc.MethodDescriptor.<Zhihu.UserInfoRequest, Zhihu.UserinfoResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetUserInfo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Zhihu.UserInfoRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Zhihu.UserinfoResponse.getDefaultInstance()))
              .setSchemaDescriptor(new ZhihuServiceMethodDescriptorSupplier("GetUserInfo"))
              .build();
        }
      }
    }
  ...
  public static abstract class ZhihuServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getUserInfo(Zhihu.UserInfoRequest request,
                            io.grpc.stub.StreamObserver<Zhihu.UserinfoResponse> responseObserver) {
    ...
    @Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                Zhihu.UserInfoRequest,
                Zhihu.UserinfoResponse>(
  ...
  public static final class ZhihuServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ZhihuServiceBlockingStub> {
    ...
    /**
     */
    public Zhihu.UserinfoResponse getUserInfo(Zhihu.UserInfoRequest request) {
      return blockingUnaryCall(
  ...
  public static final class ZhihuServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ZhihuServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Zhihu.UserinfoResponse> getUserInfo(
        Zhihu.UserInfoRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_GET_USER_INFO:
          serviceImpl.getUserInfo((Zhihu.UserInfoRequest) request,
              (io.grpc.stub.StreamObserver<Zhihu.UserinfoResponse>) responseObserver);
          break;
        default:
