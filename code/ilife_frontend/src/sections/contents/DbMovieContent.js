...
export default class DbMovieContent extends Component {
  ...
  async getMovies(username) {
    ...
    var config = {
      method: 'get',
      url: 'http://18.162.168.229:8383/douban/getMovies?userId=' + doubanId,
      headers: {
        withCredentials: true,
      }
    };
  ...
  */
  ...
  crawl() {
    var config = {
      method: 'get',
      url: 'http://18.162.168.229:8484/douban/crawlMovie?userId=' + this.state.doubanId + '&limit=2&type=movie',
      headers: {
        withCredentials: true,
      }
    };
