...
export default class DbMovieContent extends Component {
  ...
  fetchStats = (userId) => {
    ...
    const config = {
      method: 'get',
      url: 'http://121.36.196.234:8484/douban/getMovieStats?userId=' + userId,
      headers: {
              ...
              <div className="box">
                ...
                {statsReady ?
                    <div className="box-body">
                        ...
                        <Paragraph>你是一个爱看电影的人，从你踏入豆瓣的小世界以来，你已经观看了{stats.allBook}部电影，书海无涯，知识作舟，要继续保持哦。</Paragraph>
                        ...
                        <Paragraph>平均评分是<Text mark strong>{stats.avgRanking}</Text>，评分最高的是<Text mark
                            ...
                            mark strong>{stats.maxRanking}</Text>分，这部电影的类型是<Text mark
                                                                                 strong>{stats.maxRankingBook.type}</Text>，有
                            <Text mark strong>{stats.maxRankingBook.hot}</Text>人与你一起看过它，
                        ...
                        你最喜欢的作品语言是<Text mark strong>{stats.preLanguage}</Text>，读一个人的著作，也是和人心灵沟通的一种方式。
